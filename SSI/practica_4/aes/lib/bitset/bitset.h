...
public:
	...
	//Desplazar tantas posicones a la izqda o dcha
	void shiftSelf(const int n, const char MODE = LEFT);
	//Desplazar tantas posicones a la izqda o dcha
	Bitset shift(const int n, const char MODE = LEFT);
