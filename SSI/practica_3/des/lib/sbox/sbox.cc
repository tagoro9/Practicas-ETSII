...
Vector Sbox::initExtension() {
	...
	cout << "Imprimiendo extension" << endl;
	return aux;
}
...
Bitset Sbox::run(const Bitset reg, const Bitset key) {
	...
	cout << "R: " << _reg << endl;
	cout << "E: " << expandido << endl;
	cout << "K: " << _key << endl;
	expandido = expandido ^ _key;
	cout << "X: " << expandido << endl;
	//Cajas S
	...
	string result_s = "";
	for (int i = 7; i >= 0; i--) {
		cout << "Vector " << 7-i << ": " << subsets[i] << endl;
		cout << "Fila: " << row[i] << endl;
		cout << "Columna: " << column[i] << endl;
...
string Sbox::padZeros(const string str, const int length) {
